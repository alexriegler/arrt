...
// TODO: This hit function assumes the boundary shape is convex and will not work otherwise.
//       Could be made to handle arbitrary shapes.
bool constant_medium::hit(const ray& r, double t_min, double t_max, hit_record& rec) const {
	// TODO: Move debug inside macro.
